...
export default function InternationalOnline() {
  ...
  const handleCategoryChange = (e) => {
    ...
    switch (value) {
      case "Jakarta International Science Fair - Online Competition":
        ...
        break;
      case "Jakarta International Science Fair - Online Competition + Certificate and Medal (SOUTH EAST ASIA ONLY)":
        setCategoryPrice("$225 USD");
        break;
      case "Jakarta International Science Fair - Online Competition + Certificate and Medal (Exclude SOUTH EAST ASIA)":
  ...
  const scriptURL =
    "https://script.google.com/macros/s/AKfycbxbPJG0esqzVsTTSe5zPhRlvEAgrmczXJM5kduQCkbGq9gwE57lTDUOL-kKzRKsiFfc/exec";
      ...
      <section className="registration-section">
        <div className="container">
          <div className="content">
            ...
            <br />
            <h4>
              HELLO JISF 2026 INTERNATIONAL CITIZEN, Please consider the
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  ...
                  >
                    ...
                    <option value="Jakarta International Science Fair - Online Competition + Certificate and Medal (SOUTH EAST ASIA ONLY)">
                      Online Competition + Certificate and Medal (SOUTH EAST
                      ASIA)
                    </option>
                    <option value="Jakarta International Science Fair - Online Competition + Certificate and Medal (Exclude SOUTH EAST ASIA)">
              ...
              <div className="user-details">
                <div className="input-box">
                  ...
                  <label>
                    ...
                    <p>Kamal Putra Simatupang</p>
                    <p>Nur Alif Rajaloa Hidayat</p>
                    <p>Irsyad Zaidan</p>
                  </label>
                  <textarea
                    type="text"
