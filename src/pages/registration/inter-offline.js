...
export default function InternationalOffline() {
  ...
  const handleCategoryChange = (e) => {
    ...
    switch (value) {
      case "Jakarta International Science Fair - Offline Competition":
        break;
      case "Jakarta International Science Fair - Offline Competition + Full Package":
        break;
      default:
        setCategoryPrice("");
        break;
  ...
  const scriptURL = "https://script.google.com/macros/s/AKfycbzpQ7pWv3Xx_hWJzYRVdvLQAmHJjn8QigoF4YBjhG2t4JKw4y1FwAx4gWlxJi3uIcSw/exec";
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  ...
                  >
                    ...
                    <option value="Jakarta International Science Fair - Offline Competition + Full Package">
