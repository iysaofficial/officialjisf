                ...
                <div className="m-auto overflow-hidden mx-4 mt-8 lg:mt-4 p-2 md:p-12 h-5/6" data-aos="zoom-in">
                    ...
                    <div id='hero' className="flex flex-col lg:flex-row py-8 justify-between text-center lg:text-left">
                        <div className="lg:w-1/2 flex flex-col justify-center" data-aos="zoom-in" data-aos-delay="200">
                            <h1 className=" md:text-5xl text-3xl font-bold text-blue-900">
                            
                                Jakarta International Science
                            </h1>
                            <h1 className="mb-5 mt-1 md:text-5xl text-3xl font-bold text-blue-900">
                            ...
                            <div className="mb-4 space-x-0 md:space-x-2 md:mb-8">
                                <a href='https://github.com/Osalumense/mld' target='_blank' className="text-white bg-blue-900 hover:bg-blue-800 inline-flex items-center justify-center w-full px-6 py-3 my-4 text-lg shadow-xl rounded-2xl sm:w-auto sm:mb-0">
                                    Open Registration
                        ...
                        <div className="flex lg:justify-end w-full lg:w-1/2" data-aos="fade-up" data-aos-delay="700">
                            <img alt="card img" className="mt-5 rounded-t float-right duration-1000 w-50" src="./assets/logo/monas.jpg" />
                        </div>
                    </div>
                </div>
            </div>
